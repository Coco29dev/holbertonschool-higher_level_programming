...
class Square:
    ...
    Attributs:
        ...
        un entier positif ou égal à zéro.

    Méthodes:
        __init__(size): Initialise un carré avec la
        taille donnée. Si la taille n'est pas un entier ou est négative,
    ...
    def __init__(self, size=0):
        ...
        Initialise l'attribut `__size` en fonction de la taille donnée
        et effectue des validations sur celle-ci.
        """
        self.__size = size
